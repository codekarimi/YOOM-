...
```bash
git clone https://github.com/codekarimi/YOOM-.git
cd yoom
```
...
Public assets used in the project can be found [here]([https://drive.google.com/file/d/1ofTpWii_sCIdJ14uQ431xWVXpYgjtQ8Q/view?usp=sharing](https://drive.google.com/file/d/1k9RTKamg4wg1aRsBTYM4yXPNsyF0iSx9/view?usp=sharing))
